...
public class OTPGenerator {
	 ...
	 */
	public Map<Integer, LocalTime> generateOTP(String key) {
		Map<Integer, LocalTime> otpMap = new HashMap<>();
		Random random = new Random();
		int OTP = 100000 + random.nextInt(900000);
		otpCache.put(key, OTP);
		otpMap.put(OTP, DateUtil.getCurrentTime().plus(EXPIRE_MIN, ChronoUnit.MINUTES));
		return otpMap;
	}
